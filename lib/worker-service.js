...
module.exports = function(config, server, log) {
    ...
    try {
        var results = new Queue('_worker_results', REDIS_PORT, REDIS_HOST, { no_ready_check: true, auth_pass: REDIS_PASSWORD });
    ...
    function Worker(workerKey, handler, log) {
        ...
        this.jobs = {};
        this.key = workerKey;
        this.queue = new Queue(workerKey, REDIS_PORT, REDIS_HOST, { no_ready_check: true, auth_pass: REDIS_PASSWORD });
